...
const CLI_PREFIX_RE = /^(?:pnpm|npm|bunx|npx)\s+(?:unmaskbot|moltbot)\b|^(?:unmaskbot|moltbot)\b/;
...
export function formatCliCommand(
  ...
  const profile = normalizeProfileName(env.UNMASKBOT_PROFILE ?? env.CLAWDBOT_PROFILE);
